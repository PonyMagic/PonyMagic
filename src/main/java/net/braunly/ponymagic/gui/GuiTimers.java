...
public class GuiTimers extends GuiIngameForge {
    ...
    public void onRender(RenderGameOverlayEvent event) {
        ...
        int xPos = resolution.getScaledWidth() / 2 - 100;
...
//            drawModalRectWithCustomSizedTexture(x - 2, yPos - 2, 0, 0, 36, 36, 36, 36);
            ...
            mc.fontRenderer.drawString("§l" + text, (int) ((x + 6 - mc.fontRenderer.getStringWidth(text) / 2) / scaleFactor), (int)((yPos + 20) / scaleFactor), 16777215);
